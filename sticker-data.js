window.STICKER_DATA = (() => {
  // Keep this order stable: shared URLs encode teams by their position.
  const TEAMS = [
    { group: "J", code: "ALG", country: "Argélia", flag: "🇩🇿" },
    { group: "J", code: "ARG", country: "Argentina", flag: "🇦🇷" },
    { group: "D", code: "AUS", country: "Austrália", flag: "🇦🇺" },
    { group: "J", code: "AUT", country: "Áustria", flag: "🇦🇹" },
    { group: "G", code: "BEL", country: "Bélgica", flag: "🇧🇪" },
    { group: "B", code: "BIH", country: "Bósnia e Herzegovina", flag: "🇧🇦" },
    { group: "C", code: "BRA", country: "Brasil", flag: "🇧🇷" },
    { group: "B", code: "CAN", country: "Canadá", flag: "🇨🇦" },
    { group: "E", code: "CIV", country: "Costa do Marfim", flag: "🇨🇮" },
    { group: "K", code: "COD", country: "Rep. Democrática do Congo", flag: "🇨🇩" },
    { group: "K", code: "COL", country: "Colômbia", flag: "🇨🇴" },
    { group: "H", code: "CPV", country: "Cabo Verde", flag: "🇨🇻" },
    { group: "L", code: "CRO", country: "Croácia", flag: "🇭🇷" },
    { group: "E", code: "CUW", country: "Curaçao", flag: "🇨🇼" },
    { group: "A", code: "CZE", country: "Tchéquia", flag: "🇨🇿" },
    { group: "E", code: "ECU", country: "Equador", flag: "🇪🇨" },
    { group: "G", code: "EGY", country: "Egito", flag: "🇪🇬" },
    { group: "L", code: "ENG", country: "Inglaterra", flag: "\u{1F3F4}\u{E0067}\u{E0062}\u{E0065}\u{E006E}\u{E0067}\u{E007F}" },
    { group: "H", code: "ESP", country: "Espanha", flag: "🇪🇸" },
    { group: "-", code: "FWC", country: "FWC", flag: "🌎" },
    { group: "I", code: "FRA", country: "França", flag: "🇫🇷" },
    { group: "E", code: "GER", country: "Alemanha", flag: "🇩🇪" },
    { group: "L", code: "GHA", country: "Gana", flag: "🇬🇭" },
    { group: "C", code: "HAI", country: "Haiti", flag: "🇭🇹" },
    { group: "G", code: "IRN", country: "Irã", flag: "🇮🇷" },
    { group: "I", code: "IRQ", country: "Iraque", flag: "🇮🇶" },
    { group: "J", code: "JOR", country: "Jordânia", flag: "🇯🇴" },
    { group: "F", code: "JPN", country: "Japão", flag: "🇯🇵" },
    { group: "A", code: "KOR", country: "Coreia do Sul", flag: "🇰🇷" },
    { group: "H", code: "KSA", country: "Arábia Saudita", flag: "🇸🇦" },
    { group: "C", code: "MAR", country: "Marrocos", flag: "🇲🇦" },
    { group: "A", code: "MEX", country: "México", flag: "🇲🇽" },
    { group: "F", code: "NED", country: "Países Baixos", flag: "🇳🇱" },
    { group: "I", code: "NOR", country: "Noruega", flag: "🇳🇴" },
    { group: "G", code: "NZL", country: "Nova Zelândia", flag: "🇳🇿" },
    { group: "L", code: "PAN", country: "Panamá", flag: "🇵🇦" },
    { group: "D", code: "PAR", country: "Paraguai", flag: "🇵🇾" },
    { group: "K", code: "POR", country: "Portugal", flag: "🇵🇹" },
    { group: "B", code: "QAT", country: "Catar", flag: "🇶🇦" },
    { group: "D", code: "RSA", country: "África do Sul", flag: "🇿🇦" },
    { group: "C", code: "SCO", country: "Escócia", flag: "\u{1F3F4}\u{E0067}\u{E0062}\u{E0073}\u{E0063}\u{E0074}\u{E007F}" },
    { group: "I", code: "SEN", country: "Senegal", flag: "🇸🇳" },
    { group: "B", code: "SUI", country: "Suíça", flag: "🇨🇭" },
    { group: "F", code: "SWE", country: "Suécia", flag: "🇸🇪" },
    { group: "F", code: "TUN", country: "Tunísia", flag: "🇹🇳" },
    { group: "D", code: "TUR", country: "Turquia", flag: "🇹🇷" },
    { group: "H", code: "URU", country: "Uruguai", flag: "🇺🇾" },
    { group: "D", code: "USA", country: "Estados Unidos", flag: "🇺🇸" },
    { group: "K", code: "UZB", country: "Uzbequistão", flag: "🇺🇿" },
    { group: "-", code: "CC", country: "Coca-Cola", flag: "🥤" },
  ];
  const STICKER_NAMES = {
  "00": "Panini Logo",
  "FWC0": "Panini Logo",
  ...
  return { TEAMS, STICKER_NAMES, displayStickerCode };
})();
